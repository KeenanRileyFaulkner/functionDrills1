...
// arrow
// declaration
let expression = "Correct answer" //No compiler errors
...
let arrow = "Correct answer" //No comiler errors
// declaration
// expression
...
// arrow
let declaration = "Correct answer"; //No compiler errors
// expression
...
let nameGreeting = nameCheck("Keenan");
...
function thatsOdd(num) {
  return (num % 2 !== 0 ? 'That is odd indeed!' : `That's not odd!`);
}

oddChecker = thatsOdd(535298539277);
...
function theEliminator(contestants, loser) {
  ...
  if(loserInArr) {
    contestants.splice(loserIndex, 1);
  }
  return contestants;
}
...
console.log(emailCheck(`keenan.r.faulkner@gmail.com`));
console.log(emailCheck(`keenanrfaulknergmail.com`));
...
//CODE HERE
function horribleBuyFrogsFunction(goldToSpend) {
  return goldToSpend / 3;
}

let totalFrogs = horribleBuyFrogsFunction(324892749);
...
//CODE HERE
function goodBuyFrogsFunction(goldToSpend) {
  return Math.floor(goldToSpend / 3);
}

let totalFrogs2 = goodBuyFrogsFunction(329853025);
